    ...
    >
                ...
                >
                  {allEntries.map((e) => (
                    <MenuItem
                      key={e.id}
                      value={e}
                      style={getStyles(e.id, process.existingEntries)}
                    >
                      {e.name}
                    </MenuItem>
                  ))}
                ...
                >
                  {allOutputs.map((e) => (
                    <MenuItem
                      key={e.id}
                      value={e}
                      style={getStyles(e.id, process.existingOutputs)}
                    >
                      {e.name}
                    </MenuItem>
                  ))}
                ...
                >
                  {allTools.map((e) => (
                    <MenuItem
                      key={e.id}
                      value={e}
                      style={getStyles(e.id, process.existingTools)}
                    >
                      {e.name}
                    </MenuItem>
                  ))}
      ...
      <DialogActions>
        ...
        <Button
          ...
          disabled={process.name === "" ? true : false}
        >
          Actualizar
        </Button>
      </DialogActions>
